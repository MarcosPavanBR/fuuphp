<script>
  ...
  import { api, BASE, getStoredToken } from '../../services/api.js';
  import { logout } from '../../state/customerSession.svelte.js';
  import { pushState, enablePush, disablePush, savePushPrefs } from '../../services/push.js';
