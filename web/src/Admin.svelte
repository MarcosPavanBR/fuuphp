<script>
  ...
  import { isAdminAuthenticated, adminToken, adminLogout } from './lib/adminSession.svelte.js';
  import AdminLogin from './lib/screens/admin/AdminLogin.svelte';
...
{#if !logged}
  <AdminLogin onLoggedIn={() => (logged = true)} />
{:else}
  <div class="admin">
    <header class="top">
