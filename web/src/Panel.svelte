<script>
  ...
  import {
    ...
    staffLogout,
    loadRestaurant,
  } from './lib/staffSession.svelte.js';
  import StaffLogin from './lib/screens/panel/StaffLogin.svelte';
...
{#if !logged}
  <StaffLogin onLoggedIn={() => (logged = true)} />
{:else}
  <div class="panel">
    <header class="top">
      <span class="store">
    ...
    {:else}
      <div class="overview-layout">
        ...
        <main class="main">
          <PanelOverview {stats} {recent} {kds} />
        </main>
      </div>
    {/if}
  </div>
